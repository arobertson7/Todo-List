...
const formatDateForEditTaskDialog = function(date) {
    let yearMonthDay = date.split("-");
...
const formatDueDateForDisplay = function(date) {
    ...
    else if (date.substring(0, 4) == today.substring(0, 4)) {
        formattedDueDate += " on " + formatShortMonthAndDay(date);
    }
...
export { formatDateFromInput, formatDateForEditTaskDialog, formatDueDateForDisplay };